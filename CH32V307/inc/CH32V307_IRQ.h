//========================================================  (C) COPYRIGHT  =====
// File Name   : CH32V307_IRQ.h
// Version     : V1.0
// Date        : 15-07-2025
// Author      : Sunwinder
// E-mail      : gisi@sunwinder.ru
// Description : CH32V307 IRQ Header File.
//==============================================================================

#ifndef __CH32V307_IRQ_H
#define __CH32V307_IRQ_H
...
typedef enum IRQn
{
    ...
    NMI_IRQn                = 2,  // 2 Non Maskable Interrupt
    ...
    FSMC_IRQn               = 64, // FSMC global Interrupt (Not used?)
